        ...
        <div class="contentContainer">
            ...
            <table class="custTable">
                ...
                <tr>
                    ...
                    <td><a href="RetrieveCustomer?custId=<%= p.getCustId()%>">Edit</a> <a href="DeleteCustomer?custId=<%= p.getCustId()%>" onclick="return confirm('Are u sure u want to REMOVE this Customer?')">Delete</a></td>
                </tr>
                <%}
            }
                %>
