 ...
 * @author foose
 */
public class StaffEditProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Product product = new Product(prodId, prodImage, prodName, prodCategory, prodDesc, prodPrice, prodStock);

            utx.begin();
            boolean success = prodService.updateItem(product);
            utx.commit();
