...
<html>
    ...
    <body>
        <div class="contentContainer">
            ...
            <button onclick="window.location.href = 'StaffproductAddEdit.jsp'" class="addButton">Add Product</button>
            <table class="prodTable">
                ...
                <tr>
                    ...
                    <td class="action"><a href="StaffRetrieveProduct?productID=<%= p.getProdId()%>"><i class="material-icons" style="color: black;">&#xe254;</i></a> </td>
