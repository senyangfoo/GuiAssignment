...
<html>
    ...
    <body>
        <div class="sidenav">
             <a href="StaffMain.jsp" <% if (currentPage.endsWith("/StaffMain.jsp")) out.print("class=\"active\""); %>><img src="images/Home-icon.svg">Main</a>
            <a href="StaffViewProduct" <% if (currentPage.endsWith("/StaffproductTable.jsp")) out.print("class=\"active\""); %>><img src="images/shopping_bag.svg">Products</a>
            <a href="StaffViewCustomer" <% if (currentPage.endsWith("/StaffcustomerTable.jsp")) out.print("class=\"active\""); %>><img src="images/person.svg">Customer</a>
            <a href="StaffViewSales" <% if (currentPage.endsWith("/salesTable.jsp")) out.print("class=\"active\""); %>><img src="images/assessment.svg">Sales Report</a>
            <div class="options">
